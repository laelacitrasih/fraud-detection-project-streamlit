...
import base64  # Tambahkan di bagian atas file jika belum ada
...
# =====================
    ...
    total = sizes.sum()
    explode = [0.05] * len(labels)  # sedikit tarik keluar
    ...
    st.pyplot(fig1)
    # === FILTER DAN TAMPILKAN CONTOH DATA ===
...
# =====================
    ...
    if os.path.exists(paper_path):
        ...
        with open(paper_path, "rb") as f:
            ...
            # Preview langsung dalam halaman
